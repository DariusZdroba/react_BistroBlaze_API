...
namespace BistroBlaze_API.Migrations
{
    ...
    [Migration("20240418145505_addShoppingCartAndCartItemsToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BistroBlaze_API.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BistroBlaze_API.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BistroBlaze_API.Models.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BistroBlaze_API.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BistroBlaze_API.Models.CartItem", b =>
                {
                    b.HasOne("BistroBlaze_API.Models.MenuItem", "MenuItem")
                        .WithMany()
                        .HasForeignKey("MenuItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BistroBlaze_API.Models.ShoppingCart", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BistroBlaze_API.Models.ApplicationUser", null)
                        .WithMany()
